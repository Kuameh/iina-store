...
about: Suggest an IINA plugin for the curated catalog
title: "Add plugin: "
labels: new-plugin
assignees: ""
---
...
<!-- One of: subtitles, appearance, playback, automation, utility, other -->
...
<!-- Known issues, required permissions that might surprise someone,
     whether it's actively maintained, etc. -->
